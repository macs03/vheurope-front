(function () {
    ...
    var translationsES = {
      ...
      "FOOTER": {
        ...
        "ABOUTUS": "<div class='container '><div class='row'> <div class='col-md-6'> <div class='box'> <div class='box-content' style='min-height: 500px'> <h5><strong>Nuestra Misión</strong></h5> <p>Dicho de la forma más sencilla, queremos ayudarte a viajar de A a B.</p><p>Nuestro objetivo es proporcionar a nuestros clientes con:</p><ul> <li>Información actualizada sobre como viajar de A a B.</li><li>Proporcionar todas las posibilidades de viaje y conexión entre dos puntos.</li><li>Una comparación rápida y fácil entre un mismo y distintos medios de transporte.</li><li>Compra de billetes de forma fiable y ágil.</li></ul> <p>Todo esto en un sólo sitio web en un par de clicks: <a href='http://www.resertrip.com'>www.resertrip.com</a></p><p>La movilidad se ha convertido en una característica clave de nues- tra sociedad global. Frente a una oferta cada vez mayor entre dis- tintos medios de transporte, la complejidad de encontrar la opor- tunidad que mejor se adapta a las necesidades del cliente y el mo- mento puede ser desalentadora.</p><p> Desde aerolíneas de bajo coste a líneas de autobús. <br>Desde el tren de alta velocidad al ferry. <br>Desde el transporte público al transporte privados (coche compar- tido, Uber, etc....) <br>Las opciones se incrementan cada día y también la complejidad. </p><p>Cómo puedo viajar fácilmente entre A y B? www.resertrip.com es la respuesta a esta pregunta, reservando tu viaje en un sitio web con sólo un par de clicks.</p></div></div></div><div class='col-md-6'> <div class='box'> <div class='box-content' style='min-height: 500px'> <h5><strong>Nuestro Proyecto</strong></h5> <p>Queremos crear no sólo una plataforma digital donde los clientes pueden comparar y comprar billetes, sino que también queremos proveer de información para facilitar el viaje. Información sobre las compañías de transporte, las terminales y estaciones (bus, tren, aeropuerto), qué actividades se pueden hacer en el punto de desti- no, etc....</p><p>Además, queremos facilitar toda clase de servicios alrededor del viaje tales como el alquiler de un coche, la reserva de un hotel, reserva de una atracción turística, etc. ... En definitiva, todo lo que necesitas en tu viaje directamente en un portal y en sólo unos clicks, y en tantos países como sea posible.</p><p>Estamos desarrollando nuestra presencia en Europa y en Sudaméri- ca en un primer momento, y tenemos planes para expandir a otros países en un futuro próximo. Tanto si estas viajando en tu propio país, como si lo haces a otro país por trabajo o por vacaciones, nos proponemos ayudarte a que tu viaje sea lo más fácil posible. Reserva tu próximo viaje en <a href='http://www.resertrip.com.'>www.resertrip.com.</a></p></div></div></div><div class='col-md-12'><br><div class='box'> <div class='box-content'> <h5><strong>Nuestro Equipo</strong></h5> <p>Somos un equipo internacional, diverso y con mucha experiencia tanto en el mundo del transporte como en marketing digital. Estamos basados en Madrid y somos la primera plataforma de viaje multimodal en internet con base en España.</p><br><br><div class='row'> <div class='col-md-4'> <div class='profile text-center'> <img src='https://s3.eu-central-1.amazonaws.com/vheurope/team/roderick.jpg' alt='' class='img-circle'> <p>Roderick</p><span>CEO & Fundador</span> </div></div><div class='col-md-4'> <div class='profile text-center'> <img src='https://s3.eu-central-1.amazonaws.com/vheurope/team/pablo.jpg' alt='' class='img-circle'> <p>Pablo</p><span>Co - Fundador, Ventas & Marketing</span> </div></div><div class='col-md-4'> <div class='profile text-center'> <img src='https://s3.eu-central-1.amazonaws.com/vheurope/team/celine.jpg' alt='' class='img-circle'> <p>Celine</p><span>Redes Sociales</span> </div></div></div><br><br><br><div class='row'> <div class='col-md-4'> <div class='profile text-center'> <img src='https://s3.eu-central-1.amazonaws.com/vheurope/team/jake.jpg' alt='' class='img-circle'> <p>Jake</p><span>Co-Fundador & CTO</span> </div></div><div class='col-md-4'> <div class='profile text-center'> <img src='https://s3.eu-central-1.amazonaws.com/vheurope/team/abel.jpg' alt='' class='img-circle'> <p>Abel</p><span>Programación & Desarrollo</span> </div></div><div class='col-md-4'> <div class='profile text-center'> <img src='https://s3.eu-central-1.amazonaws.com/vheurope/team/jhesus-colmenares.jpg' alt='' class='img-circle'> <p>Jesús</p><span>Programación & Desarrollo</span> </div></div></div></div></div></div></div></div>",
