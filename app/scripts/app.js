(function() {
    ...
    var translationsEN = {
        "MAIN": {
            ...
            "FERRY": "Ferry",
            "CAR": "Car",
            "FIND_PASSAGES": "Find your bus ticket in ",
            "CTA_BUY": "Purchase from your",
            "CTA_POSSIBILITY": "ALL POSSIBILITIES OF TRIPS",
            "CTA_PLACE": "in one single place",
            "CTA_PHONE": "MOBILE",
            "BUS_COMPANIES": "Our Partners",
    ...
    var translationsES = {
        "MAIN": {
            ...
            "FERRY": "Barco",
            "CAR": "Auto",
            "FIND_PASSAGES": "Encuentra tus billetes de autobús en ",
            "CTA_BUY": "Compra desde tu",
            "CTA_PHONE": "MOVIL",
            "CTA_POSSIBILITY": "TODAS LAS POSIBILIDADES DE VIAJE",
            "CTA_PLACE": "en un solo lugar",
            "BUS_COMPANIES": "Nuestros Socios",
        ...
        "FOOTER": {
            ...
            "TERMS_CONTENT": "<p class='lead text-center'>CONDICIONES GENERALES</p><p class='text-justify'><b>RESERTRIP</b></p><p class='text-justify'><b>RESERTRIP</b> es una plataforma multimodal que facilita la comparación y venta de billetes de varios modos de transporte en varios países. <b>RESERTRIP</b> ejerce de intermediario entre el usuario y el transportista.</p><p class='text-justify'>El usuario es cualquier persona o empresa que quiere comprar un billete de transporte para viajar entre dos ciudades.</p><p class='text-justify'>El transportista es la empresa de transporte que organiza el transporte de pasajeros entre dos ciudades que se puede realizar en autobús, tren, avión, coche o barco. Cada transportista dispone de unas condiciones generales de transporte que aplica a su sector y a su país. En ningún caso <b>RESERTRIP</b> se hace responsable de daños y perjuicios que podrían ocurrir durante el viaje. Para conocer las condiciones generales de cada transportista recomendamos consultar la pagine web de cada empresa.</p><p class='text-justify'><b>Responsabilidad</b></p><p class='text-justify'>La responsabilidad del transportista incumbe a la empresa que realiza efectivamente el servicio. La empresa transportista no responderá de los incumplimientos que no le sean directamente imputables, ni de los producidos por caso fortuito, fuerza mayor, o por atender exigencias legales o administrativas. Del mismo modo, no se hace responsable de las pérdidas de enlace de sus servicios con otros transportes, ya sean propios o ajenos. En servicios internacionales, la responsabilidad que pudiera existir incumbe a la empresa que realiza el transporte, con arreglo a las Leyes y Tribunales de su país.<p class='text-justify'><b>Equipajes</b><p class='text-justify'>Cada empresa de transporte establece el peso máximo de equipaje a transportar gratuitamente. El exceso deberá ser abonado según la cuantía que por tarifa corresponda. En caso de facturación del equipaje, la empresa hará entrega del correspondiente resguardo.</p><p class='text-justify'>En caso de pérdida o deterioro del equipaje transportado, será imprescindible efectuar la reclamación en los plazos indicados en el apartado de 'Reclamaciones' exhibiendo el billete y el resguardo de facturación, en su caso.</p><p class='text-justify'>La responsabilidad del transportista estará limitada en servicios nacionales según la legislación vigente en cada país. En servicios internacionales la responsabilidad corresponde a la empresa que efectivamente efectúa el transporte conforme a la legislación que proceda. El transportista no responderá de los daños, pérdidas o averías que sufran los bultos de mano u otros objetos no confiados a su custodia.</p><p class='text-left'><b>Bicicletas</b></p><p class='text-justify'>Las condiciones para el transporte de bicicletas varían en función de la empresa transportista. Consultar directamente las condiciones de cada transportista.</p><p class='text-left'><b>Mascotas</b></p><p class='text-justify'>Las condiciones para el transporte de mascotas varían en función de la empresa transportista. Consultar directamente las condiciones de cada transportista.</p><p class='text-left'><b>Anulación y cambio de billetes</b></p><p class='text-justify'>La anulación y el cambio de los billetes vendidos a través de la web de <b>RESERTRIP</b> se podrán realizar a través del enlace facilitado tras la compra del billete en <b>RESERTRIP</b> o directamente con la empresa transportista, y siempre según las condiciones generales de cada una.</p><p class='text-left'><b>Anulación y cambio de billetes Ouibus</b></p><ol class='text-justify' style='list-style-type: decimal;'><li>BILLETES <p class='text-justify'>Los Billetes OUIBUS son no reembolsables, no anulables, pero sí cambiables.</p></li><li>DERECHO DE RETRACTACIÓN</li><ol style='list-style-type: disc;'><li>De acuerdo con el artículo L.221-2 del Código del consumo, la venta a distancia de billetes de servicios de transporte de pasajeros no está sometido a la aplicación del derecho de retractación previsto en los artículos L.221-18 y siguientes del Código del consumo.</li><li>En consecuencia, las Prestaciones solicitadas a distancia (en el Sitio OUIBUS, la aplicación móvil o por teléfono) sólo están sometidas a las condiciones de cambio y anulación previstas en las presentes Condiciones Generales.</li></ol><li>CAMBIO</li><ol style='list-style-type: disc;'><li>El Billete OUIBUS es nominativo y únicamente válido para el trayecto comprado. Por lo tanto es necesario proceder a su cambio en el Sitio OUIBUS, la Aplicación móvil o por teléfono para modificar uno o varios de los siguientes elementos de su viaje, en particular:</li><ol style='list-style-type: circle;'><li>El día y / o la hora de salida</li><li>Los tratamientos, apellidos, nombres y fecha de nacimiento del pasajero</li><li>Los Servicios anexos</li></ol><li>El Billete OUIBUS sólo se puede cambiar por otro Billete OUIBUS.</li><li>Para el cambio de la identidad del Pasajero: dentro de las 12 horas posteriores a la compra del Billete OUIBUS, el cambio es gratuito en el sitio OUIBUS, la aplicación móvil. Más allá, el cambio da lugar a gastos de tramitación que ascienden a 5 euros, aplicables por Pasajero y por trayecto cambiado (1 Billete OUIBUS de ida simple = 1 trayecto y 1 Billete OUIBUS ida y vuelta = 2 trayectos). En caso de cambio de la identidad del Pasajero por teléfono, el cambio dará lugar a gastos de tramitación que ascienden a 10 €, aplicables por Pasajero y por trayecto cambiado (1 Billete OUIBUS de ida simple = 1 trayecto y 1 Billete OUIBUS ida y vuelta = 2 trayectos).</li><li>Para el cambio de horarios o de fecha de viaje y trayecto: en caso de cambio de horarios o de fecha de viaje y de trayecto en el Sitio OUIBUS o la aplicación móvil, el cambio dará lugar a gastos de tramitación que ascienden a 5 €, aplicables por pasajero y por trayecto cambiado (1 Billete OUIBUS de ida simple = 1 trayecto y 1 Billete OUIBUS ida y vuelta = 2 trayectos). En caso de cambio de horarios por teléfono, el cambio dará lugar a gastos de tramitación que ascienden a 10 €, aplicables por pasajero y por trayecto cambiado (1 Billete OUIBUS de ida simple = 1 trayecto y 1 Billete OUIBUS ida y vuelta = 2 trayectos).</li><li>El cambio de un Billete OUIBUS sólo es posible si se cumplen todas las siguientes condiciones:</li><ol style='list-style-type: circle;'><li>El cambio del Billete OUIBUS debe efectuarse a más tardar 15 minutos antes de la salida del trayecto a cambiar, y en los horarios de apertura del centro de cambio cuando el cambio se realiza por teléfono.</li><li>Quedan plazas disponibles para el nuevo trayecto elegido en el nuevo autocar elegido.</li><li>Si el precio del nuevo Billete OUIBUS es superior al precio del que desea cambiar, deberá pagar la diferencia además de los eventuales gastos de tramitación aplicables.</li><li>Si el precio del nuevo Billete OUIBUS es inferior al precio del que desea cambiar, recibirá un Vale de compra, habiéndose deducido los eventuales gastos de tramitación aplicables.</li><li>En lo concerniente al cambio de Servicios anexos, éste sólo es posible</li><ol style='list-style-type: square;'><li>Si el servicio de reemplazo está vinculado a un Billete OUIBUS ya encargado, válido para un autocar cuyas plazas ya están abiertas para la reserva.</li><li>Si no se describe el Servicio Anexo como no cambiable en el Sitio OUIBUS.</li></ol></ol></ol></ol><p class='text-left'><b>Cierre de billetes con vuelta abierta</b></p><p class='text-justify'>Si en el billete de ida y vuelta no figuran consignados el día, hora y asiento relativos al regreso, el viajero deberá presentarse en la oficina correspondiente de ventas de la empresa con la mayor antelación posible para confirmar el regreso, que estará condicionado a la existencia de plazas disponibles en la fecha solicitada.</p><p class='text-left'><b>Precio de los billetes</b></p><p class='text-justify'>El importe total de los billetes comprados por Internet, se compone del precio del billete según las tarifas vigentes, más en algunos casos la cantidad adicional expresada en concepto de coste de gestión que cobra la parte vendedora.</p><p class='text-left'><b>Reclamaciones</b></p><p class='text-justify'>Si el viajero desea efectuar algún tipo de reclamación contra la empresa transportista, deberá formularla en el plazo más breve posible desde la fecha en que se haya prestado o se hubiere debido prestar el servicio de transporte. La reclamación será tramitada conforme a lo dispuesto en la legislación vigente.</p><p class='text-left'><b>Descuentos</b></p><p class='text-justify'>La compra de billetes por medio de Internet permite la aplicación de descuentos en función de la política comercial de cada empresa.</p><p class='text-justify'>Es imprescindible para acceder al autobús, tren, avión o ferry la presentación de la documentación acreditativa que confiere el derecho al descuento.</p><p class='text-left'><b>Titularidad del billete</b></p><p class='text-justify'>Los billetes adquiridos por Internet son nominativos personales e intransferibles. Para su utilización se requiere la comprobación de un documento personal del viajero y que este dato corresponda con el número de identificación personal reflejado en el billete.</p><p class='text-justify'>Para viajar es necesario la presentación de un documento personal, tanto si se accede directamente con el billete impreso en la web de <b>RESERTRIP</b>, como si se solicita la impresión física del billete en el punto de venta.</p><p class='text-justify'>En los billetes adquiridos por Internet para menores de edad aplican condiciones especiales para identificar a las personas que acompañan al menor.</p><p class='text-left'><b>Proceso de compra</b></p><p class='text-justify'></p><p class='text-justify'><b>RESERTRIP</b> permite la compra del billete en su página web o redirige a la web del transportista para terminar el proceso de compra.<p class='text-justify'>Una vez terminado el proceso de compra, es imprescindible que pulse el botón IMPRIMIR que aparecerá en su pantalla en el 'Resultado de la Compra'. Si no desea imprimir el billete, o no le es posible, por favor, anote el localizador en un lugar seguro para solicitar la impresión del billete en la taquilla de la empresa transportista.</p><p class='text-justify'>En el caso de una compra en la página web de <b>RESERTRIP</b> procederemos a recoger el nombre del viajero, una dirección de correo electrónico e información relativa al medio de pago (la cual será procesada a través de un proveedor de pago externo). Posteriormente, remitiremos la reserva y el precio del viaje al correspondiente transportista. La venta de billetes tendrá lugar en nombre y por cuenta del respectivo transportista.</p><p class='text-justify'>Al clicar sobre el botón 'PAGAR AHORA' que se encuentra en nuestras páginas de reserva, usted nos ofrecerá un contrato para la intermediación del transporte o viaje en cuestión. La reserva efectuada a través de nuestras páginas solo se considerará aceptada por nosotros cuando haya recibido la confirmación de reserva. Recibirá por correo electrónico todos los documentos necesarios para el viaje junto con la confirmación de reserva enviada.</p><p class='text-justify'>Los transportes y viajes que se pueden reservar a través de <b>RESERTRIP</b> solo se podrán reservar mediante las opciones de pago indicadas en cada caso.</p><p class='text-justify'>En el caso de que cancele el transporte o viaje o desista del contrato, los costes que se produzcan en dicho concepto se regirán de conformidad con las condiciones generales de contratación y los términos contractuales del transportista en cuestión. Por tanto, la cancelación y el desistimiento del contrato deberán declararse frente al correspondiente transportista. En el caso de que declare la cancelación o el desistimiento frente a <b>RESERTRIP</b>, solo podrá darse la remisión al transportista si realiza la declaración por escrito (correo electrónico o carta ordinaria) e indicando el correspondiente número de reserva. De manera alternativa, también ofrecemos para determinados proveedores de viajes una opción de cancelación directamente en nuestras páginas.</p><p class='text-left'><b>Texto legal</b></p><p class='text-justify'>En cumplimiento de lo dispuesto en la Ley Orgánica 15/1999, de 13 de diciembre, de Protección de Datos de Carácter Personal, vigente en España, le informamos que los datos personales facilitados serán incluidos en un fichero titularidad de <b>RESERTRIP</b> con la finalidad de llevar a cabo las gestiones correspondientes a la compra del billete seleccionado.</p><p class='text-justify'>Asimismo, le informamos que los datos facilitados como consecuencia de la compra se almacenarán en DATOS <b>RESERTRIP</b> y además serán transferidos a los sistemas de las compañías de transporte de viajeros. Tanto DATOS <b>RESERTRIP</b> como las compañías de transporte se responsabilizan de su confidencialidad en los términos exigidos legalmente, de acuerdo con sus políticas específicas de privacidad.</p><p class='text-justify'>Los datos señalados con un asterisco son de cumplimentación obligatoria, suponiendo su ausencia la imposibilidad de gestionar la compra seleccionada.</p><p class='text-justify'>El envío de sus datos implica aceptar y consentir el tratamiento de los mismos, que serán incorporados a un fichero debidamente inscrito en el Registro General de Protección de Datos.</p><p class='text-justify'>Entendemos que los datos facilitados son del propio usuario y que son ciertos, reservándose <b>RESERTRIP</b> el derecho a excluir de los servicios ofertados a todo usuario que haya facilitado datos falsos, sin perjuicio de las demás acciones que procedan en Derecho. El usuario se hace responsable de comunicar a <b>RESERTRIP</b> cualquier modificación de los datos personales facilitados.</p><p class='text-justify'>El acceso a esta web puede implicar la utilización de cookies. Las cookies son pequeñas cantidades de información que se almacenan en el navegador utilizado por cada usuario para que el servidor recuerde cierta información que posteriormente pueda utilizar. Esta información permite identificarle a usted como un usuario concreto y permite guardar sus preferencias personales, así como información técnica como puedan ser visitas o páginas concretas que visite. Aquellos usuarios que no deseen recibir cookies o quieran ser informados antes de que se almacenen en su ordenador, pueden configurar su navegador a tal efecto.</p><p class='text-justify'>El ejercicio de los derechos de acceso, rectificación, cancelación y oposición, podrá llevarse a cabo, conforme a lo dispuesto en la normativa vigente, mediante solicitud dirigida a nuestra dirección de correo electrónico info@resertrip.com o a la dirección postal: <b>RESERTRIP</b> S.L., Avenida General Perón 26, Madrid 28020, España, adjuntando en todo caso, fotocopia de su D.N.I o documento equivalente válido en derecho que permita acreditar su identidad.</p><p class='text-left'><b>Factura</b></p><p class='text-justify'>Si el cliente desea la factura de sus billetes tiene que ponerse en contacto con la empresa transportista.</p><p class='text-left'><b>Conexiones</b></p><p class='text-justify'>De acuerdo con la legislación de transportes algunos de los trayectos pueden realizarse mediante conexión de servicios con combinación de horarios de una parada determinada y expedición única de billetes, lo que requeriría un cambio de autobús, tren o avión en dicha parada.</p><p class='text-left'><b>Documentación</b></p><p class='text-justify'>Cada pasajero debe llevar la documentación necesaria (pasaporte, visados, etc.…) para cruzar las fronteras, según las leyes del país o países por los que transiten. Si por causas de no llevar la documentación o no tenerla en regla, el viajero no fuese admitido al embarque, o se le prohíba la entrada en algún país, todos los gastos originados serán a su cargo, incluidos los de retorno y no procederá el reembolso del billete no utilizado.</p><p class='text-justify'>El billete debe ser conservado por el viajero durante todo el trayecto, tanto de ida como de regreso. En caso de extravío del billete el cliente deberá ponerse en contacto con la empresa transportista.</p><p class='text-left'><b>Menores</b></p><p class='text-justify'>En servicios internacionales, los menores de 16 años deben viajar acompañados de un adulto legalmente autorizado. Los jóvenes con edades comprendidas entre 16 y 18 años, necesitan pasaporte y autorización policial para viajar.</p><p class='text-justify'>En servicios nacionales, las condiciones de viaje para el transporte de menores sin acompañante varían en función de la empresa transportista. Rogamos consulten en cada caso.</p><p class='text-left'><b>Medios de Pago</b></p><p class='text-justify'>El pago con tarjeta financiera de crédito o débito y en algunas ocasiones con PayPal o transferencia bancaria en línea son los únicos medios de pago aceptados en <a href='www.resertrip.com'>www.resertrip.com</a>.</p><p class='text-left'><b>Datos de contacto</b></p><p class='text-justify'>Denominación Social: <b>RESERTRIP S.L.</b> <br>Domicilio social: Avenida General Peron 26, Madrid 28020, España. <br>Dirección de contacto: Avenida General Peron 26, Madrid 28020, España. <br>C.I.F. B87535829 <br>Datos de Inscripción en el Registro Mercantil: inscrita en el Registro Mercantil de Madrid, al Tomo 34702, Libro 0, Folio 10, Sección 8, Hoja M624172.<br>Dirección de correo electrónico: <a href='mailto:info@resertrip.com'>info@resertrip.com</a>.<br>Teléfono de contacto: 00 34 663815114 <br></p>"
        },
        "PASSENGERS": {
            "TITLE": "Pasajeros",
            "ADULTS": "Adultos",
    ...
    var translationsFR = {
        "MAIN": {
            ...
            "FERRY": "Ferry",
            "CAR": "Covoiturage",
            "FIND_PASSAGES": "Trouver votre billet de bus en ",
        ...
        "FOOTER": {
            ...
            "TERMS_CONTENT": "<p class='lead text-center'>CONDITIONS GÉNÉRALES</p><p class='text-justify'><b>RESERTRIP</b></p><p class='text-justify'><b>RESERTRIP</b> est une plate-forme multimodale qui facilite la comparaison et la vente de billets de moyens de transport différents dans divers pays. <b>RESERTRIP</b> sert d’intermédiaire entre l’usager et le transporteur.</p><p class='text-justify'></p>L’usager est toute personne ou entreprise qui souhaite acheter un billet de transport pour voyager entre deux villes.<p class='text-justify'>Le transporteur est la société de transport qui organise le transport de passager entre deux villes qui peut se faire par bus, train, avion, voiture ou ferry. Chaque transporteur dispose de conditions générales de transport qu’il applique à son secteur et à son pays. En aucun cas <b>RESERTRIP</b> n’assume la responsabilité des dommages et intérêts pouvant survenir durant le voyage. Pour connaître les conditions générales des transporteurs, nous vous recommandons de consulter la page web de chaque entreprise.</p><p class='text-justify'><b>Responsabilité</b></p><p class='text-justify'>La responsabilité du transporteur incombe à l’entreprise qui offre effectivement le service. L’entreprise de transport ne répondra pas des manquements ne lui étant pas directement imputables, ni de ceux découlant de situations fortuites, de cas de force majeure ou répondant à des exigences légales ou administratives. De même, elle ne sera pas tenue responsable en cas de perte des correspondances entre leurs services et d’autres moyens de transport, que ceux-ci soient propres ou externes. Pour les services internationaux, la responsabilité pouvant exister incombera à l’entreprise qui réalisera le transport, conformément aux Lois et aux Tribunaux de son pays.<p class='text-justify'><b>Bagages</b><p class='text-justify'>Chaque entreprise de transport établit le poids maximum des bagages transportés gratuitement. L’excès devra être payé en fonction du tarif correspondant. En cas d’enregistrement des bagages, l’entreprise remettra le récépissé afférent.</p><p class='text-justify'>En cas de perte ou de détérioration des bagages transportés, il sera indispensable de présenter une réclamation dans les délais indiqués à l’alinéa des « Réclamations » en présentant le billet et le récépissé d’enregistrement, le cas échéant.</p><p class='text-justify'>La responsabilité du transporteur sera limitée, pour les services nationaux, selon la législation en vigueur dans chaque pays. Pour les services internationaux, la responsabilité incombera à l’entreprise qui assurera effectivement le transport, conformément à la législation opportune. Le transporteur ne répondra pas des dommages, des pertes ou des avaries subis par les bagages à main ou tout autre objet qui ne lui auront pas été confiés.</p><p class='text-left'><b>Bicyclettes</b></p><p class='text-justify'>Les conditions de transport des bicyclettes varient en fonction de l’entreprise de transport. Veuillez consulter directement les conditions de chaque transporteur.</p><p class='text-left'><b>Animaux de compagnie</b></p><p class='text-justify'>Les conditions de transport des animaux de compagnie varient en fonction de l’entreprise de transport. Veuillez consulter directement les conditions de chaque transporteur.</p><p class='text-left'><b>Annulation et modification de billets</b></p><p class='text-justify'>L’annulation et la modification des billets vendus au travers de la page Web de <b>RESERTRIP</b> pourront être réalisées au travers du lien fourni après l’achat du billet sur <b>RESERTRIP</b> ou directement auprès de l’entreprise de transport et toujours selon les conditions générales de chacune.</p><p class='text-left'><b>Annulation et modification de billets Ouibus</b></p><ol class='text-justify' style='list-style-type: decimal;'><li>TITRES DE TRANSPORT <p class='text-justify'>Les Billets OUIBUS sont non remboursables, non-annulables, mais échangeables.</p></li><li>DROIT DE RETRACTATION</li><ol style='list-style-type: disc;'><li>Conformément à l'article L.221-2 du Code de la consommation, la vente à distance de titres services de transport de passagers n'est pas soumise à l'application du droit de rétractation prévu aux articles L.221-18 et suivants du Code de la consommation.</li><li>En conséquence, les Prestations commandées à distance (sur le Site OUIBUS, l’application mobile ou par téléphone) sont uniquement soumises aux conditions d’échange et d'annulation prévues aux présentes Conditions Générales.</li></ol><li>ECHANGE</li><ol style='list-style-type: disc;'><li>Le Billet OUIBUS est nominatif et uniquement valable pour le trajet acheté. Il est donc nécessaire de procéder à son échange sur le Site OUIBUS, l’Application mobile ou par téléphone pour modifier un ou plusieurs des éléments suivants de votre voyage, dont notamment:</li><ol style='list-style-type: circle;'><li>Le jour et/ou l'heure de départ.</li><li>Les civilités, noms, prénoms et date de naissance du passager.</li><li>Les services annexes.</li></ol><li>Le Billet OUIBUS n’est échangeable que contre un autre Billet OUIBUS.</li><li>Pour l’échange de l’identité du Passager : dans les 12 heures suivant l’achat du Billet OUIBUS, l’échange est gratuit sur le site OUIBUS, l’application mobile. Au-delà, l’échange donnera lieu à des frais de dossier qui s’élèvent à 5 euros, applicables par Passager et par trajet échangé (1 Billet OUIBUS aller simple = 1 trajet et 1 Billet OUIBUS aller-retour = 2 trajets). En cas d’échange de l'identité du Passager par téléphone, l’échange donnera lieu à des frais de dossiers qui s’élèvent à 10 €, applicables par Passager et par trajet échangé (1 Billet OUIBUS aller simple = 1 trajet et 1 Billet OUIBUS aller-retour = 2 trajets).</li><li>Pour l’échange d’horaires ou de date de voyage et de trajet : en cas d’échange d’horaires ou de date de voyage et de trajet sur le Site OUIBUS ou l’application mobile, l’échange donnera lieu à des frais de dossiers qui s’élèvent à 5 €, applicables par passager et par trajet échangé (1 Billet OUIBUS aller simple = 1 trajet et 1 Billet OUIBUS aller-retour = 2 trajets). En cas d’échange d’horaires par téléphone, l’échange donnera lieu à des frais de dossiers qui s’élèvent à 10 €, applicables par passager et par trajet échangé (1 Billet OUIBUS aller simple = 1 trajet et 1 Billet OUIBUS aller-retour = 2 trajets).</li><li>L'échange d’un Billet OUIBUS n'est possible que si toutes les conditions suivantes sont remplies:</li><ol style='list-style-type: circle;'><li>L'échange du Billet OUIBUS doit être effectué au plus tard 15 minutes avant le départ du trajet à échanger, et dans les horaires d'ouverture du centre d’échange lorsque l’échange est réalisé par téléphone.</li><li>Il reste des places disponibles pour le nouveau trajet choisi dans le nouvel autocar choisi.</li><li>Si le prix du nouveau Billet OUIBUS est supérieur au prix de celui que Vous voulez échanger, Vous devrez payer la différence en sus des éventuels frais de dossiers applicables.</li><li>Si le prix du nouveau Billet OUIBUS est inférieur au prix de celui que Vous voulez échanger, Vous recevrez un Bon d’achat, déduction faite des éventuels frais de dossiers applicables.</li><li>Concernant l’échange de Services annexes, celui-ci n’est possible que:</li><ol style='list-style-type: square;'><li>Si le service de remplacement se rattache à un Billet OUIBUS déjà commandé, valable pour un autocar dont les places sont déjà ouvertes à la réservation.</li><li>Si le Service Annexe n’est pas décrit comme non échangeable sur le Site OUIBUS.</li></ol></ol></ol></ol><p class='text-left'><b>Réservation du retour de billets open</b></p><p class='text-justify'>Si sur le billet aller-retour, la date, l’heure et la place ne sont pas stipulées pour le retour, le voyageur devra se rendre, dans les plus brefs délais, au bureau de vente correspondant de l’entreprise, pour confirmer le retour qui dépendra des places disponibles à la date demandée.</p><p class='text-left'><b>Prix des billets</b></p><p class='text-justify'>Le montant total des billets achetés sur Internet comprend le prix du billet selon les tarifs en vigueur, plus - dans certains cas - la somme supplémentaire au titre des frais de gestion perçus par la partie vendeuse.</p><p class='text-left'><b>Réclamations</b></p><p class='text-justify'>Si le voyageur souhaite présenter une réclamation à l’encontre de l’entreprise de transport, il devra la formuler dans les plus brefs délais à compter de la date de prestation du service de transport ou de celle à laquelle celui-ci aurait dû avoir lieu. La réclamation sera traitée conformément aux dispositions de la législation en vigueur.</p><p class='text-left'><b>Réductions</b></p><p class='text-justify'>L’achat de billets sur Internet permet d’appliquer des réductions en fonction de la politique commerciale de chaque entreprise.</p><p class='text-justify'>Il est indispensable pour monter dans l’autobus, le train ou l’avion, de présenter la documentation justificative conférant le droit à la réduction.</p><p class='text-left'><b>Propriété du billet</b></p><p class='text-justify'>Les billets achetés sur Internet sont nominatifs, personnels et incessibles. Pour pouvoir les utiliser, le voyageur doit présenter une pièce d’identité dont le numéro devra coïncider avec celui stipulé sur le billet.</p><p class='text-justify'>Pour pouvoir voyager, il faudra présenter une pièce d’identité à l’embarquement, que le billet ait été directement imprimé à partir de la page Web de <b>RESERTRIP</b> ou que l’impression physique du billet ait été demandée au point de vente.</p><p class='text-justify'>Pour les billets achetés sur Internet pour des mineurs, des conditions spéciales d’identification s’appliquent aux personnes accompagnant le mineur.</p><p class='text-left'><b>Processus d’achat</b></p><p class='text-justify'></p>A titre de règle générale, <b>RESERTRIP</b> permet d’acheter le billet sur sa page Web. Dans certains cas où ceci s’avèrera impossible, l’acheteur sera redirigé sur le site Web du transporteur pour terminer le processus d’achat.</p><p class='text-justify'>Une fois le processus d’achat achevé, il est indispensable de cliquer sur le bouton IMPRIMER s’affichant à l’écran dans le « Résultat de l’achat ». Si vous ne souhaitez pas imprimer le billet ou que vous n’en avez pas la possibilité, veuillez prendre note du numéro de réservation et conservez-le en lieu sûr pour demander l’impression du billet au guichet de l’entreprise de transport.</p><p class='text-left'><b>Texte légal</b></p><p class='text-justify'>Conformément aux dispositions de la Loi organique 15/1 999, du 13 décembre, sur la Protection des données à caractère personnel, en vigueur en Espagne, nous vous informons que les données personnelles fournies seront incluses dans un fichier appartenant à l’entreprise, dans le but de réaliser les formalités correspondant à l’achat du billet sélectionné.</p><p class='text-justify'>De même, nous vous informons que les renseignements fournis dans le cadre de l’achat seront emmagasinés dans un fichier DONNEES <b>RESERTRIP</b> et qu’ils seront, en outre, transférés aux systèmes des sociétés de transport de voyageurs. Aussi bien les DONNEES <b>RESERTRIP</b> que les sociétés de transport assument la responsabilité de leur confidentialité dans les termes exigés légalement, conformément à leurs politiques spécifiques de confidentialité.</p><p class='text-justify'>Les champs signalés avec un astérisque doivent être obligatoirement remplis, leur absence supposant l’impossibilité de traiter l’achat sélectionné.</p><p class='text-justify'>L’envoi de vos données implique que vous acceptez et vous consentez qu’elles soient traitées. Celles-ci seront intégrées à un fichier dûment inscrit au Registre général de Protection des données.</p><p class='text-justify'>Nous considérons que les données fournies sont du propre usager et qu’elles sont vraies, <b>RESERTRIP</b> se réservant le droit d’exclure des services offerts tout usager  ayant fourni des renseignements faux, sans préjudice des autres actions prévues en droit.</p><p class='text-justify'>Il incombe à l’usager de communiquer à <b>RESERTRIP</b> toute modification des renseignements personnels fournis.</p><p class='text-justify'>Les droits d’accès, de rectification, d’annulation et d’opposition pourront être exercés, conformément aux dispositions de la réglementation en vigueur, par le biais d’une demande adressée à notre adresse courriel info@resertrip.com ou à l’adresse postale : <b>RESERTRIP</b> S.L., Avenida General Perón 26, Madrid 28020, Espagne, en joignant dans tous les cas, la photocopie de votre C.N.I. ou de toute pièce d’identité équivalente valable en droit.</p><p class='text-left'><b>Facture</b></p><p class='text-justify'>Si le client souhaite une facture de ses billets, il devra contacter l’entreprise de transport.</p><p class='text-left'><b>Correspondances</b></p><p class='text-justify'>Conformément à la législation des transports, certains parcours peuvent être réalisés avec une correspondance et une combinaison d’horaires à un arrêt déterminé, en délivrant un seul billet et qui requiert donc un changement d’autobus, de train ou d’avion à cet arrêt.</p><p class='text-left'><b>Documentation</b></p><p class='text-justify'>Chaque passager doit être en possession de la documentation nécessaire (passeport, visas, etc.) pour passer les frontières, conformément aux lois du ou des pays qu’il traversera. Si, dans le cas où il ne disposerait pas de la documentation ou que celle-ci ne serait pas en règle, le voyageur n’est pas admis au moment de l’embarquement ou que l’entrée dans un pays lui est interdite, tous les frais en découlant seront à sa charge, y compris ceux de retour et il ne pourra prétendre au remboursement du billet non utilisé.</p><p class='text-justify'>Le billet doit être conservé par le voyageur pendant toute la durée du voyage, aussi bien à l’aller qu’au retour. En cas de perte du billet, le client devra contacter l’entreprise de transport.</p><p class='text-left'><b>Mineurs</b></p><p class='text-justify'>Pour les services internationaux, les mineurs de moins de 16 ans doivent voyager accompagnés d’un adulte légalement autorisé. Les adolescents âgés de 16 à 18 ans, doivent être munis d’un passeport et d’une autorisation des services de police pour voyager.</p><p class='text-justify'>Pour les services nationaux, les conditions de voyage pour le transport de mineurs non accompagnés varient en fonction de l’entreprise de transport. Nous vous prions de vous renseigner dans chaque cas.</p><p class='text-left'><b>Moyens de paiement</b></p><p class='text-justify'>Le paiement par carte bancaire - de crédit ou de débit - est le seul moyen de paiement accepté sur <a href='www.resertrip.com'>www.resertrip.com</a>.</p><p class='text-left'><b>Informations de contact</b></p><p class='text-justify'>Raison sociale : <b>RESERTRIP S.L.</b> <br>Siège social : Avenida General Perón 26, Madrid 28020, Espagne. <br>Adresse de contact : Avenida General Perón 26, Madrid 28020, Espagne. <br>SIRET : B87535829 <br>Immatriculation au Registre du Commerce et des Sociétés: immatriculée au Registre du Commerce et des Sociétés de Madrid, au Tome 34 702, Livre 0, Folio 10, Section 8, Feuille M624 172.<br>Courriel : <a href='mailto:info@resertrip.com'>info@resertrip.com</a>.<br>Téléphone de contact : 00 34 663815114 <br></p>"
        },
        "PASSENGERS": {
            "TITLE": "Passagers",
            "ADULTS": "Adultes",
